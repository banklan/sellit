            ...
            <form class="form-horizontal" onsubmit="event.preventDefault()">
                <div class="form-group">
                    <div class="input-group" v-if="!searching">
                        <input type="text" class="form-control" v-model="query.service" @keyup.enter="search" placeholder="Search for service ad only..">
            ...
            search(){
                if(this.query.service != ''){
        			...
        			axios.post('/service_search', {
                        ...
                        vm.$router.push({name: 'serviceSearchResult', query:{service: vm.query.service}, params: {result: res.data}})
                    })
                }
            }
        },
